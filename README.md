...
- [Docling Java — Developer Documentation](https://docling-project.github.io/docling-java/dev/)
...
- [Profiling Allocation Hotspots in Spring Boot: Real Tools, Real Fixes](https://systemweakness.com/profiling-allocation-hotspots-in-spring-boot-real-tools-real-fixes-7eed552de171)
- [Claude Code Template for Spring Boot](https://piotrminkowski.com/2026/03/24/claude-code-template-for-spring-boot/)
...
- [FREE CCNA — What is a Network? (Jeremy's IT Lab)](https://www.youtube.com/watch?v=S7MNX_UD7vY&list=PLIhvC56v63IJVXv0GJcl9vO5Z6znCVb1P)
...
- [K6 Performance Testing - Introduction, Installation & Run First Script](https://www.youtube.com/watch?v=SzlRJpshKzk&list=PLFGoYjJG_fqoum_IoPpbLN3AwWIWtr6hq&ab_channel=NaveenAutomationLabs)
- [What Software Architects Do That Programmers DON'T](https://youtu.be/IwrvE-wHm84?si=VtL1VUkdhJ1AwO29)
- [How I add millions of rows to MySQL (for performance testing)](https://youtu.be/ywp9Z0xZPzo?si=X74Fui8ISCw38VBI)
- [How to Debug - Lessons Learnt from 10 Years of Spring Boot](https://youtube.com/watch?v=rJcQqBGEJw4&si=r499UdHjMg1AsVKw)
...
- [Software Performance: Avoiding Slow Code, Myths & Sane Approaches – Casey Muratori](https://youtube.com/watch?v=apREl0KmTdQ&feature=shared)
...
- [The Ultimate List of Software Architecture Books in 2024](https://www.workingsoftware.dev/the-ultimate-list-of-software-architecture-books-in-2024/)
...
- [Conventional Commits Specification v1.0.0](https://www.conventionalcommits.org/en/v1.0.0/?fbclid=IwAR2pcs5YyUcC5awqGy_mH5b-t9n9-RArBh0QaKdXBaiwCz2VggNOxRmC6XA)
...
- [AsyncAPI Initiative for Event-Driven APIs](https://www.asyncapi.com/en)
- [Behind The Scenes Of Bun Install](https://bun.com/blog/behind-the-scenes-of-bun-install)
- [Migrate Java to Azure — VS Code Extension](https://marketplace.visualstudio.com/items?itemName=vscjava.migrate-java-to-azure)
...
- [How I Design Software — Hussein Nasser](https://hnasr.substack.com/p/how-i-design-software?r=6xhat&utm_medium=ios&triedRedirect=true)
